...
typedef enum _ipfix_bird_information_element {
  ...
  IPFIX_IE_BIRD_PROTOCOL_STATE, /* PS_* */
  IPFIX_IE_BIRD_LAST_STATE_CHANGE,

  IPFIX_IE_BIRD_IMP_ROUTES,
  IPFIX_IE_BIRD_IMP_FILTERED_ROUTES,
  IPFIX_IE_BIRD_IMP_PREFERRED_ROUTES,
  IPFIX_IE_BIRD_IMP_UPDATES,
  IPFIX_IE_BIRD_IMP_INVALID_UPDATES,
  IPFIX_IE_BIRD_IMP_FILTERED_UPDATES,
  IPFIX_IE_BIRD_IMP_IGNORED_UPDATES,
  IPFIX_IE_BIRD_IMP_ACCEPTED_UPDATES,
  IPFIX_IE_BIRD_IMP_WITHDRAWS,
  IPFIX_IE_BIRD_IMP_INVALID_WITHDRAWS,
  IPFIX_IE_BIRD_IMP_IGNORED_WITHDRAWS,
  IPFIX_IE_BIRD_IMP_ACCEPTED_WITHDRAWS,

  IPFIX_IE_BIRD_EXP_ROUTES,

  IPFIX_IE_BIRD_EXP_UPDATES,  
  IPFIX_IE_BIRD_EXP_REJECTED_UPDATES,
